    ...
    render(){
        return (
            <div>
                ...
                <main id="content">
                    <section className="pb-7 page-title position-relative z-index-2">
                    ...
                    <section className="pb-7 shadow-xs-1 position-relative z-index-1 mt-n17">
                        ...
                        <div className="row">
                            ...
                            <img src="images/agent-41.jpg" className="card-img" alt="" />
                            </div>
                            <div className="col-md-7">
                            <div className="pl-md-10 pr-md-8 py-7">
                                <h2 className="fs-30 text-dark font-weight-600 lh-16 mb-0">Blanche Gordon</h2>
                                <p className="fs-16 font-weight-500 lh-213 mb-4">Real estate broker, agent</p>
                                <p className="mb-1">Copany Agent at <a href="/" className="text-heading">Modern House Real Estate</a>
                                </p>
                                <p className="mb-6">Lorem ipsum dolor sit amet, consec tetur cing elit. Suspe ndisse suscorem ipsum
                                dolor
                                sit ametcipsum
                                dolor sit t, consec tetur atetur cing elit. Suspe ndisse susco rem ipsum dolor sit ametcipsum
                                doloamet.</p>
                                <hr className="mb-4" />
                                <div className="row">
                                <div className="col-sm-6 mb-4">
                                    <p className="mb-0">Phone</p>
                                    <p className="text-heading font-weight-500 mb-0 lh-13">+98 0390 909 039</p>
                                    <p className="text-heading font-weight-500 mb-0 lh-13">+98 0900 098 888</p>
                                </div>
                                <div className="col-sm-6 mb-4">
                                    <p className="mb-0">Email</p>
                                    <p className="text-heading font-weight-500 mb-0 lh-13">b.gordon@homeid.com</p>
                                </div>
                                <div className="col-sm-6 mb-4">
                                    <p className="mb-0">Language</p>
                                    <p className="text-heading font-weight-500 mb-0 lh-13">English, French, Spanish</p>
                                </div>
                                <div className="col-sm-6 mb-4">
                                    <p className="mb-0">Website</p>
                                    <p className="text-heading font-weight-500 mb-0 lh-13">thememove.com</p>
                                </div>
                                </div>
                                <hr className="mb-4" />
                        ...
                        <div className="row">
                            ...
                            <div className="primary-sidebar-inner">
                                ...
                                <div className="card-body px-6 py-6">
                                    ...
                                    <img src="images/agent-42.jpg" className="rounded-circle mr-2" alt="Blanche Gordon" />
                                    <div className="media-body">
                                        <p className="fs-16 lh-1 text-dark mb-0 font-weight-500">
                                        Blanche Gordon
                                        </p>
                                        <p className="mb-0">Real estate broker, agent</p>
                                        <p className="text-heading font-weight-500 mb-0">
                                        <span className="text-primary d-inline-block mr-1"><i className="fal fa-phone" /></span>
                                        123 900 68668
                                        </p>
                                    </div>
                                    </div>
                                    ...
                                    <div className="form-group mb-4">
                                        ...
                                        <textarea className="form-control border-0 shadow-none" rows={5} id="message" placeholder="Message" defaultValue={""} />
                                    </div>
