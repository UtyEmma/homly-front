    ...
    return (
        <section className="bg-gray-02 pt-9 pb-lg-13 pb-11">
            <div className="container container-xxl">
                <h2 className="text-heading c-title">Properties We Love The Most</h2>
                <span className="heading-divider" />
                <p className="mb-7">Some properties currently on sale, we just can't get enough of.</p>
                ...
                <Slider {...settings} >
                    <div className="box px-0" >
                        ...
                        <div className="card-img-overlay d-flex justify-content-end flex-column p-4">
                            ...
                            <p className="fs-13 font-weight-500 letter-spacing-087 mb-0">FROM<span className="ml-2 fs-15 font-weight-bold">$540.000 </span>
                            </p>
                        </div>
                        </div>
                    </div>
                    <div className="box px-0" >
                        ...
                        <div className="card-img-overlay d-flex justify-content-end flex-column p-4">
                            ...
                            <p className="fs-13 font-weight-500 letter-spacing-087 mb-0">FROM<span className="ml-2 fs-15 font-weight-bold">$520.000 </span>
                            </p>
                        </div>
                        </div>
                    </div>
                    <div className="box px-0" >
                        ...
                        <div className="card-img-overlay d-flex justify-content-end flex-column p-4">
                            ...
                            <p className="fs-13 font-weight-500 letter-spacing-087 mb-0">FROM<span className="ml-2 fs-15 font-weight-bold">$340.000 </span>
                            </p>
                        </div>
                        </div>
                    </div>
                    <div className="box px-0">
                        ...
                        <div className="card-img-overlay d-flex justify-content-end flex-column p-4">
                            ...
                            <p className="fs-13 font-weight-500 letter-spacing-087 mb-0">FROM<span className="ml-2 fs-15 font-weight-bold">$240.000 </span>
                            </p>
                        </div>
                        </div>
                    </div>
                    <div className="box px-0">
                        ...
                        <div className="card-img-overlay d-flex justify-content-end flex-column p-4">
                            ...
                            <p className="fs-13 font-weight-500 letter-spacing-087 mb-0">FROM<span className="ml-2 fs-15 font-weight-bold">$380.000 </span>
                            </p>
                        </div>
                        </div>
                    </div>
