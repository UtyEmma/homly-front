    ...
    return (
        <ScrollAnimation animateIn="fadeInUp" className="col-sm-6 col-md-4 col-lg-3 mb-6">
            <div className="card shadow-hover-xs-4 agent-3">
                ...
                <a href={`/${agent.username}`} className="d-block fs-16 lh-2 text-dark mb-0 font-weight-500 hover-primary">
                ...
                <a href={`../${agent.username}`} className="d-flex align-items-center justify-content-center text-heading">
