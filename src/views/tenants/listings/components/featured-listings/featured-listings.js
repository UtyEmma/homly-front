                            ...
                            <div className="box px-0" >
                                <div className="card border-0">
                                    ...
                                    <div className="card-img-overlay d-flex flex-column bg-gradient-3 rounded-lg">
                                        ...
                                        <a href={`listings/${listing.slug}`} className="text-white"><h5 className="card-title fs-16 lh-2 mb-0">{listing.title}</h5>
                                        </a>
                                        <p className="card-text text-gray-light mb-0 font-weight-500">{listing.address}, {listing.city}, {listing.state}</p>
                                        <p className="text-white mb-0"><span className="fs-17 font-weight-bold">$ {listing.rent} </span>/{listing.tenure}
                                        </p>
                                        </div>
                                    </div>
                                </div>
