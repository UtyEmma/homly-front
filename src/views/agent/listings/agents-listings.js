              ...
              <div className="d-flex flex-wrap flex-md-nowrap mb-6">
                <div className="mr-0 mr-md-auto">
                  ...
                  <p>
                    ...
                    {listings && listings.length > 0 ? " are all" : " will be"} listed
                    below
                  </p>
                </div>
                  ...
                  <div className="p-2">
                    <div className="input-group input-group-lg bg-white border">
                      ...
                      <input
                        type="text"
                        onChange={(e) => {
                          FilterResults(e, ".filter-row", ".filter-item");
                        }}
                        className="font-weight-normal form-control bg-transparent border-0 shadow-none text-body"
