...
const {
  ...
  GETLISTINGS_FAILURE,
  GETLISTINGS_REQUEST,
  ACTIVE_LISTINGS_REQUEST,
  ACTIVE_LISTINGS_SUCCESS,
  ACTIVE_LISTINGS_FAILURE,
  ...
  FETCH_SINGLE_LISTING_REQUEST,
  FETCH_SINGLE_LISTING_SUCCESS,
  FETCH_SINGLE_LISTING_FAILURE,
  FETCH_POPULAR_LISTINGS_REQUEST,
  FETCH_POPULAR_LISTINGS_SUCCESS,
  FETCH_POPULAR_LISTINGS_FAILURE,
  SET_AS_RENTED_REQUEST,
  SET_AS_RENTED_SUCCESS,
  SET_AS_RENTED_FAILURE,
  UPDATE_LISTING_VIEWS_REQUEST,
  UPDATE_LISTING_VIEWS_SUCCESS,
  UPDATE_LISTING_VIEWS_FAILURE,
} = ListingConstants;
...
export const showPaginationListing =
  (token, params, pageNumber) => (dispatch) => {
    console.log("pagination listings...");

    dispatch({ type: ACTIVE_LISTINGS_REQUEST });

    ListingService.fetchPaginationListings(token, params, pageNumber).then((response) => {
